              ...
              <ul className="mt-6 grid gap-x-8 gap-y-10 sm:grid-cols-2 lg:grid-cols-3">
                {result.docs.map((doc) => {
                  ...
                  return (
                    ...
                    >
                      <div className="relative aspect-[16/10] w-full overflow-hidden border border-line-soft bg-surface-alt transition-colors duration-500 group-hover:border-shell-900">
                        {cover ? (
                          <Image
                            src={cover.url}
                            alt=""
